...
const writePaths = [
  ...
  /^commercial\/tasks\/[^/]+$/,
  /^commercial\/transfer-documents\/[^/]+$/,
  /^commercial\/transfer-cases\/[^/]+\/status$/,
  /^commercial\/projects\/[^/]+\/media(?:\/upload-request)?$/,
  /^commercial\/project-media\/[^/]+\/confirm-upload$/,
  /^admin\/users(?:\/[^/]+)?$/,
