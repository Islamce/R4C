...
const readPaths = [
  ...
  /^crm\/(?:contacts|opportunities|activities|tasks)$/,
...
const writePaths = [
  ...
  /^crm\/(?:contacts|opportunities|activities|tasks|quotations)$/,
  /^crm\/leads\/[^/]+\/convert$/,
  /^crm\/opportunities\/[^/]+\/stage$/,
  /^crm\/tasks\/[^/]+\/status$/,
  /^crm\/quotations\/[^/]+\/revisions$/,
  /^crm\/quotation-revisions\/[^/]+\/(?:status|decision)$/,
