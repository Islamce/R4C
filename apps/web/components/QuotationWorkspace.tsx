...
const labels = {
  en: {
    ...
    document: "Controlled document preview (HTML)",
    ...
    approve: "Approve to send", return: "Return to draft", withdraw: "Withdraw", revise: "Create revision", preview: "Open controlled document preview (HTML)", link: "Generate test link",
  ...
  ar: {
    ...
    document: "معاينة المستند المحكومة (HTML)",
    ...
    approve: "اعتماد للإرسال", return: "إعادة إلى مسودة", withdraw: "سحب", revise: "إنشاء مراجعة", preview: "فتح معاينة المستند المحكومة (HTML)", link: "إنشاء رابط اختبار",
