...
The automated verification must pass dependency installation, lint, typecheck, tests, build, Docker service inspection, Web login endpoint, API readiness, and MinIO readiness.

## 3. Manual acceptance journeys
...
- Every critical manual journey is Pass.
