...
with sync_playwright() as p:
    ...
    page.screenshot(path=str(OUT / "quotation-pdf-preview-en-1440.png"), full_page=True)
    ...
    page.screenshot(path=str(OUT / "buyer-pdf-preview-en-1440.png"), full_page=True)
    ...
    page.get_by_role("button", name="فتح معاينة PDF").click()
    page.screenshot(path=str(OUT / "quotation-pdf-preview-ar-1440.png"), full_page=True)
